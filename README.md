...
#### 0. **سیستم احراز هویت پنل مدیریت** 🔐
- ورود به پنل مدیریت با نام کاربری و رمز عبور
- **نام کاربری**: `admin`
- **رمز عبور**: `iran@1404`
- ذخیره وضعیت ورود به مدت 24 ساعت
- مودال ورود با طراحی مدرن
- امکان خروج از پنل مدیریت
- حفاظت از دسترسی غیرمجاز به اطلاعات دانش آموزان
...
2. وارد کردن نام کاربری (`admin`) و رمز عبور (`iran@1404`)
3. مشاهده آمار و لیست دانش آموزان
4. استفاده از امکانات جستجو و فیلتر
5. خروجی گرفتن از اطلاعات
6. آپلود لیست دانش آموزان مورد انتظار
7. خروج از پنل مدیریت هنگام پایان کار
...
## اطلاعات احراز هویت پنل مدیریت

- **نام کاربری**: `admin`
- **رمز عبور**: `iran@1404`
- **مدت اعتبار ورود**: 24 ساعت
- **URL تست**: https://8000-i9sr06pic2fl5n9zo1v27-6532622b.e2b.dev

---

**آخرین به‌روزرسانی**: 2 اکتبر 2025
**وضعیت**: ✅ آماده برای استفاده با احراز هویت
**نسخه**: 1.1.0